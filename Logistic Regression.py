...
#iris.Species = iris.Class.replace(to_replace=['Iris-setosa', 'Iris-versicolor'], value=[0, 1])
...
# Step 5: Building the model framework
...
plt.xlabel('Number of epochs')
plt.ylabel('Accuracy')
plt.title('Train and Test Accuracy Plot')
plt.legend(loc='best')
plt.show()
